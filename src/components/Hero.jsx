...
const Hero = () => {
  ...
  return (
    <>
      <div className="Top-container -mt-10 md:mt-0 h-screen w-screen overflow-hidden">
        {activeImage !== null && (
          <>
            <div
        ...
        <div
          ...
          className={`HeroText md:absolute mt-48 md:mt-0 md:top-[12rem] relative md:left-[30rem] z-50 text-[#494444] ${
      ...
      <div className="Highbuttons absolute top-1/2 right-1/4 ml-3 hidden md:mt-36 md:flex flex-col gap-6 md:top-[14rem] md:left-[27rem] md:flex-row">
      ...
      <div className="LowButtons z-50 absolute scale-75 md:scale-100 -ml-10 md:bottom-0 -bottom-16 md:mb-12 md:ml-40 mb-24 flex items-center md:gap-4">
