    ...
    <div className="page1 overflow-hidden flex h-[80vh] lg:h-[95vh] p-[1vw_2vw]">
        <div className="page1-left w-[70%]">
          ...
          <div className="page1-items flex mt-[5vh]">
            ...
            <img onClick={() => changeBackground('darkpurple', 'main-3.png', 'right-text-3.png', 180, 3)} className={`w-[9vw] h-[9vw] lg:w-[10vw] lg:h-[10vw] bg-[#FFFEFE] p-[1vw] rounded-full shadow-[0_3px_10px_#A68661] ${activeButton === 'darkpurple' && 'darkpurple'}`} src="./assets/right-image-3.png" alt="" />
